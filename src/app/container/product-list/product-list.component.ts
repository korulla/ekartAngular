...
export class ProductListComponent {
  ...
  totalProdCount = this.product.length
  // const inStockCount = this.product.filter(product => product.is_in_inventory === true)
  inStockCountArray = this.product.filter(product => product.is_in_inventory === true);
  outOfStockCountArray = this.product.filter(product => product.is_in_inventory === false);
  inStockCount = this.inStockCountArray.length
  outOfStockCount = this.outOfStockCountArray.length  
  ...
  onFilterChange(event){
    this.selectedFilterRadioBtn = event
  }
